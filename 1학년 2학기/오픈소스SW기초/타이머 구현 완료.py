...
def show_start_screen():
    """시작 화면 표시"""
    global start_button, instruction_button
    canvas.delete("all")
    ...
    # 게임 설명 버튼
    instruction_button = tk.Button(root, text="게임 설명", font=("Arial", 14), command=lambda: [show_instructions(), start_button.destroy(), instruction_button.destroy()])
